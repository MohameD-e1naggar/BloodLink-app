...
class _BloodBankNotificationsState extends State<BloodBankNotifications> {
  // البيانات الأساسية للفصائل الثمانية
  ...
  // دالة تحديد الحالة والألوان بناءً على المخزون
  ...
  void _showInventoryDialog() {
    ...
    bool isAdding = true; // الحالة الافتراضية هي إضافة
        ...
        builder: (context, setDialogState) => AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              // اختيار نوع العملية (إضافة أو سحب)
              ToggleButtons(
