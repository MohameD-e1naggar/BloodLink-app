...
class BloodBankResponsiblePersonScreen extends StatefulWidget {
  ...
  const BloodBankResponsiblePersonScreen(
      {
        super.key,
  ...
  @override
  State<BloodBankResponsiblePersonScreen> createState() =>
      _BloodBankResponsiblePersonScreenState();
}

class _BloodBankResponsiblePersonScreenState extends State<BloodBankResponsiblePersonScreen> {
  ...
  void _createAccount() async {
    ...
    try {
      ...
      if (mounted) {
        Navigator.pushNamedAndRemoveUntil(context, Routes.bloodBankLoginRoute, (route) => false);
      }
